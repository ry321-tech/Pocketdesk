...
<%   try {
        ...
        String sql ="select networkmembers_master.user_id,users_master.user_name,users_master.url_img From networkmembers_master INNER JOIN users_master ON networkmembers_master.user_id=users_master.user_id WHERE networkmembers_master.network_name='mickey'";
